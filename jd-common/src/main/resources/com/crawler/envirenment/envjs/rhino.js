...
var __this__ = this;
var _base_package_='/com/crawler/envirenment';
var initBase=function(basePackage){
    _base_package_=basePackage;
}
var require = (function() {
    ...
    function normalize(id) {
		var file;
        id = id + '.js';
        var resourcePath=_base_package_+"/"+id;
        var url= java.lang.Thread.currentThread().getClass().getResource(resourcePath);
        if(url!=null){
            return url;
        }
        if (/^\.\.?/.test(id)) {
            ...
            var resourcePath=_base_package_+"/"+id;
            print(resourcePath);
            var url= java.lang.Thread.currentThread().getContextClassLoader().getResource(resourcePath);
            if(url!=null){
...
window=Window;
location=Location;
location.host='passport.yhd.com'
